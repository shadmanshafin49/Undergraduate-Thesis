...
\begingroup
    ...
    \begin{center}
        \wildcard{\centerline{Md. Abrar-ud-doula Amiya} ~\\ \centerline{21301567}} % "centerline{}" to center line
        \hspace{2cm}
        \ % "hspace{}" for Blank Horizontal space
        \wildcard{\centerline{Shadman Sakib} ~\\ \centerline{21301566} }
        \wildcard{\centerline{Mahima Islam} ~\\ \centerline{21201143} }
        \hspace{2cm}
        \wildcard{\centerline{Nafi Alif Mahin} ~\\ \centerline{21201699} }
        \hspace{1.5cm}
        \wildcard{\centerline{Muntasir Mahin Siam} ~\\ \centerline{21301708} }
    \end{center}
